...
function C001$4(_a) {
    var _b = _a.menu, menu = _b === void 0 ? data$4.menu : _b;
    var _c = React.useState(false), isOpened = _c[0], setOpen = _c[1];
    return (jsxs("header", { children: [jsx("div", __assign({ className: "bg-gray-100 border-b border-gray-200" }, { children: jsx("div", __assign({ className: "px-4 mx-auto sm:px-6 lg:px-8" }, { children: jsxs("nav", __assign({ className: "relative flex items-center justify-between h-16 lg:h-20" }, { children: [jsx("div", __assign({ className: "hidden lg:flex lg:items-center lg:space-x-10" }, { children: menu.map(function (eachFeature, idx) {
                                    return (jsxs("a", __assign({ href: eachFeature.toLowerCase(), title: "", className: "text-base font-medium text-black" }, { children: [" ", eachFeature, " "] }), idx));
                                }) })), jsx("div", __assign({ className: "lg:absolute lg:-translate-x-1/2 lg:inset-y-5 lg:left-1/2" }, { children: jsx("div", __assign({ className: "flex-shrink-0" }, { children: jsx("a", __assign({ href: "#", title: "", className: "flex" }, { children: jsx("img", { className: "w-auto h-8 lg:h-10", src: "https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg", alt: "" }) })) })) })), jsx("button", __assign({ type: "button", className: "flex items-center justify-center ml-auto text-white bg-black rounded-full w-9 h-9 lg:hidden" }, { children: jsx("svg", __assign({ className: "w-5 h-5", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" }) })) })), jsx("button", __assign({ onClick: function () { return setOpen(true); }, type: "button", className: "inline-flex p-2 ml-5 text-black transition-all duration-200 rounded-md lg:hidden focus:bg-gray-100 hover:bg-gray-100" }, { children: jsx("svg", __assign({ className: "w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M4 6h16M4 12h16m-7 6h7" }) })) })), jsxs("div", __assign({ className: "hidden lg:flex lg:items-center lg:space-x-10" }, { children: [jsx("a", __assign({ href: "#", title: "", className: "text-base font-medium text-black" }, { children: " Sign up " })), jsx("a", __assign({ href: "#", title: "", className: "text-base font-medium text-black" }, { children: " Sign in " })), jsx("a", __assign({ href: "#", title: "", className: "flex items-center justify-center w-10 h-10 text-white bg-black rounded-full" }, { children: jsx("svg", __assign({ className: "w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" }) })) }))] }))] })) })) })), isOpened && jsx("nav", __assign({ className: "py-4 bg-white lg:hidden" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto sm:px-6 lg:px-8" }, { children: [jsxs("div", __assign({ className: "flex items-center justify-between" }, { children: [jsx("p", __assign({ className: "text-sm font-semibold tracking-widest text-gray-400 uppercase" }, { children: "Menu" })), jsx("button", __assign({ onClick: function () { return setOpen(false); }, type: "button", className: "inline-flex p-2 text-black transition-all duration-200 rounded-md focus:bg-gray-100 hover:bg-gray-100" }, { children: jsx("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", className: "w-6 h-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" }) })) }))] })), jsxs("div", __assign({ className: "mt-6" }, { children: [jsx("div", __assign({ className: "flex flex-col space-y-2" }, { children: menu.map(function (eachFeature, idx) {
                                        return (jsxs("a", __assign({ href: eachFeature.toLowerCase(), title: "", className: "py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600" }, { children: [" ", eachFeature] }), idx));
                                    }) })), jsx("hr", { className: "my-4 border-gray-200" }), jsxs("div", __assign({ className: "flex flex-col space-y-2" }, { children: [jsx("a", __assign({ href: "#", title: "", className: "py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600" }, { children: " Sign up " })), jsx("a", __assign({ href: "#", title: "", className: "py-2 text-base font-medium text-black transition-all duration-200 focus:text-blue-600" }, { children: " Sign in " }))] }))] }))] })) }))] }));
}
...
function C002$4(_a) {
    var _b = _a.menu, menu = _b === void 0 ? data$4.menu : _b;
    var _c = React.useState(false), isOpened = _c[0], setOpen = _c[1];
    return (jsx("header", __assign({ className: "pb-6 bg-white lg:pb-0" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" }, { children: [jsxs("nav", __assign({ className: "flex items-center justify-between h-16 lg:h-20" }, { children: [jsx("div", __assign({ className: "flex-shrink-0" }, { children: jsx("a", __assign({ href: "#", title: "", className: "flex" }, { children: jsx("img", { className: "w-auto h-8 lg:h-10", src: "https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg", alt: "" }) })) })), jsx("button", __assign({ onClick: function () { return setOpen(!isOpened); }, type: "button", className: "inline-flex p-2 text-black transition-all duration-200 rounded-md lg:hidden focus:bg-gray-100 hover:bg-gray-100" }, { children: !isOpened ? jsx("svg", __assign({ className: "block w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M4 8h16M4 16h16" }) }))
                                : jsx("svg", __assign({ className: "w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" }) })) })), jsx("div", __assign({ className: "hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10" }, { children: menu.map(function (eachFeature, idx) {
                                return (jsxs("a", __assign({ href: eachFeature.toLowerCase(), title: "", className: "text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600" }, { children: [" ", eachFeature, " "] }), idx));
                            }) })), jsx("a", __assign({ href: "#", title: "", className: "items-center justify-center hidden px-4 py-3 ml-10 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md lg:inline-flex hover:bg-blue-700 focus:bg-blue-700", role: "button" }, { children: " Get started now " }))] })), isOpened && jsxs("nav", __assign({ className: "pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden" }, { children: [jsx("div", __assign({ className: "flow-root" }, { children: jsx("div", __assign({ className: "flex flex-col px-6 -my-2 space-y-1" }, { children: menu.map(function (eachFeature, idx) {
                                    return (jsxs("a", __assign({ href: eachFeature.toLowerCase(), title: "", className: "inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600" }, { children: [" ", eachFeature, " "] }), idx));
                                }) })) })), jsx("div", __assign({ className: "px-6 mt-6" }, { children: jsx("a", __assign({ href: "#", title: "", className: "inline-flex justify-center px-4 py-3 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md tems-center hover:bg-blue-700 focus:bg-blue-700", role: "button" }, { children: " Get started now " })) }))] }))] })) })));
}
...
var C001$3 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-white sm:pt-16 lg:pt-24" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl" }, { children: [jsxs("div", __assign({ className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12" }, { children: [jsxs("div", __assign({ className: "col-span-2 md:col-span-4 xl:pr-8" }, { children: [jsx("img", { className: "w-auto h-9", src: logoSrc, alt: "" }), jsx("p", __assign({ className: "text-base leading-relaxed text-gray-600 mt-7" }, { children: description })), jsxs("a", __assign({ href: "#", title: "", className: "inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700 mt-7" }, { children: [jsx("svg", __assign({ className: "w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" }) })), "Start Live Chat"] }))] })), jsxs("div", __assign({ className: "lg:col-span-2" }, { children: [jsx("p", __assign({ className: "text-base font-semibold text-gray-900" }, { children: "Company" })), jsx("ul", __assign({ className: "mt-6 space-y-5" }, { children: company && company.map(function (each, idx) {
                                        return (jsx("li", { children: jsxs("a", __assign({ href: each.link, title: "", className: "flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600" }, { children: [" ", each.title] })) }, idx));
                                    }) }))] })), jsxs("div", __assign({ className: "lg:col-span-2" }, { children: [jsx("p", __assign({ className: "text-base font-semibold text-gray-900" }, { children: "Help" })), jsx("ul", __assign({ className: "mt-6 space-y-4" }, { children: help && help.map(function (each, idx) {
                                        return (jsx("li", { children: jsxs("a", __assign({ href: each.link, title: "", className: "flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600" }, { children: [" ", each.title] })) }, idx));
                                    }) }))] })), jsxs("div", __assign({ className: "lg:col-span-2" }, { children: [jsx("p", __assign({ className: "text-base font-semibold text-gray-900" }, { children: "Resources" })), jsx("ul", __assign({ className: "mt-6 space-y-5" }, { children: resource && resource.map(function (each, idx) {
                                        return (jsx("li", { children: jsxs("a", __assign({ href: each.link, title: "", className: "flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600" }, { children: [" ", each.title, " "] })) }, idx));
                                    }) }))] })), jsxs("div", __assign({ className: "lg:col-span-2" }, { children: [jsx("p", __assign({ className: "text-base font-semibold text-gray-900" }, { children: "Extra Links" })), jsx("ul", __assign({ className: "mt-6 space-y-5" }, { children: extraLinks && extraLinks.map(function (each, idx) {
                                        return (jsx("li", { children: jsxs("a", __assign({ href: each.link, title: "", className: "flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600" }, { children: [" ", each.title] })) }, idx));
                                    }) }))] }))] })), jsx("hr", { className: "mt-16 mb-10 border-gray-200" }), jsxs("div", __assign({ className: "sm:flex sm:items-center sm:justify-between" }, { children: [jsx("p", __assign({ className: "text-sm text-gray-600" }, { children: "\u00A9 Copyright 2021, All Rights Reserved by Postcraft" })), jsxs("ul", __assign({ className: "flex items-center mt-5 space-x-3 md:order-3 sm:mt-0" }, { children: [jsx("li", { children: jsx("a", __assign({ href: "#", title: "", className: "flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-orange-600 hover:text-white focus:text-white hover:bg-orange-600 hover:border-orange-600 focus:border-orange-600" }, { children: jsx("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: jsx("path", { d: "M19.633 7.997c.013.175.013.349.013.523 0 5.325-4.053 11.461-11.46 11.461-2.282 0-4.402-.661-6.186-1.809.324.037.636.05.973.05a8.07 8.07 0 0 0 5.001-1.721 4.036 4.036 0 0 1-3.767-2.793c.249.037.499.062.761.062.361 0 .724-.05 1.061-.137a4.027 4.027 0 0 1-3.23-3.953v-.05c.537.299 1.16.486 1.82.511a4.022 4.022 0 0 1-1.796-3.354c0-.748.199-1.434.548-2.032a11.457 11.457 0 0 0 8.306 4.215c-.062-.3-.1-.611-.1-.923a4.026 4.026 0 0 1 4.028-4.028c1.16 0 2.207.486 2.943 1.272a7.957 7.957 0 0 0 2.556-.973 4.02 4.02 0 0 1-1.771 2.22 8.073 8.073 0 0 0 2.319-.624 8.645 8.645 0 0 1-2.019 2.083z" }) })) })) }), jsx("li", { children: jsx("a", __assign({ href: "#", title: "", className: "flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-orange-600 hover:text-white focus:text-white hover:bg-orange-600 hover:border-orange-600 focus:border-orange-600" }, { children: jsx("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: jsx("path", { d: "M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z" }) })) })) }), jsx("li", { children: jsx("a", __assign({ href: "#", title: "", className: "flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-orange-600 hover:text-white focus:text-white hover:bg-orange-600 hover:border-orange-600 focus:border-orange-600" }, { children: jsxs("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: [jsx("path", { d: "M11.999 7.377a4.623 4.623 0 1 0 0 9.248 4.623 4.623 0 0 0 0-9.248zm0 7.627a3.004 3.004 0 1 1 0-6.008 3.004 3.004 0 0 1 0 6.008z" }), jsx("circle", { cx: "16.806", cy: "7.207", r: "1.078" }), jsx("path", { d: "M20.533 6.111A4.605 4.605 0 0 0 17.9 3.479a6.606 6.606 0 0 0-2.186-.42c-.963-.042-1.268-.054-3.71-.054s-2.755 0-3.71.054a6.554 6.554 0 0 0-2.184.42 4.6 4.6 0 0 0-2.633 2.632 6.585 6.585 0 0 0-.419 2.186c-.043.962-.056 1.267-.056 3.71 0 2.442 0 2.753.056 3.71.015.748.156 1.486.419 2.187a4.61 4.61 0 0 0 2.634 2.632 6.584 6.584 0 0 0 2.185.45c.963.042 1.268.055 3.71.055s2.755 0 3.71-.055a6.615 6.615 0 0 0 2.186-.419 4.613 4.613 0 0 0 2.633-2.633c.263-.7.404-1.438.419-2.186.043-.962.056-1.267.056-3.71s0-2.753-.056-3.71a6.581 6.581 0 0 0-.421-2.217zm-1.218 9.532a5.043 5.043 0 0 1-.311 1.688 2.987 2.987 0 0 1-1.712 1.711 4.985 4.985 0 0 1-1.67.311c-.95.044-1.218.055-3.654.055-2.438 0-2.687 0-3.655-.055a4.96 4.96 0 0 1-1.669-.311 2.985 2.985 0 0 1-1.719-1.711 5.08 5.08 0 0 1-.311-1.669c-.043-.95-.053-1.218-.053-3.654 0-2.437 0-2.686.053-3.655a5.038 5.038 0 0 1 .311-1.687c.305-.789.93-1.41 1.719-1.712a5.01 5.01 0 0 1 1.669-.311c.951-.043 1.218-.055 3.655-.055s2.687 0 3.654.055a4.96 4.96 0 0 1 1.67.311 2.991 2.991 0 0 1 1.712 1.712 5.08 5.08 0 0 1 .311 1.669c.043.951.054 1.218.054 3.655 0 2.436 0 2.698-.043 3.654h-.011z" })] })) })) }), jsx("li", { children: jsx("a", __assign({ href: "#", title: "", className: "flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-orange-600 hover:text-white focus:text-white hover:bg-orange-600 hover:border-orange-600 focus:border-orange-600" }, { children: jsx("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: jsx("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M12.026 2c-5.509 0-9.974 4.465-9.974 9.974 0 4.406 2.857 8.145 6.821 9.465.499.09.679-.217.679-.481 0-.237-.008-.865-.011-1.696-2.775.602-3.361-1.338-3.361-1.338-.452-1.152-1.107-1.459-1.107-1.459-.905-.619.069-.605.069-.605 1.002.07 1.527 1.028 1.527 1.028.89 1.524 2.336 1.084 2.902.829.091-.645.351-1.085.635-1.334-2.214-.251-4.542-1.107-4.542-4.93 0-1.087.389-1.979 1.024-2.675-.101-.253-.446-1.268.099-2.64 0 0 .837-.269 2.742 1.021a9.582 9.582 0 0 1 2.496-.336 9.554 9.554 0 0 1 2.496.336c1.906-1.291 2.742-1.021 2.742-1.021.545 1.372.203 2.387.099 2.64.64.696 1.024 1.587 1.024 2.675 0 3.833-2.33 4.675-4.552 4.922.355.308.675.916.675 1.846 0 1.334-.012 2.41-.012 2.737 0 .267.178.577.687.479C19.146 20.115 22 16.379 22 11.974 22 6.465 17.535 2 12.026 2z" }) })) })) })] }))] }))] })) })));
};
...
var C002$3 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-gray-50 sm:pt-16 lg:pt-24" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl" }, { children: [jsxs("div", __assign({ className: "grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12" }, { children: [jsxs("div", __assign({ className: "col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8" }, { children: [jsx("img", { className: "w-auto h-9", src: logoSrc, alt: "" }), jsx("p", __assign({ className: "text-base leading-relaxed text-gray-600 mt-7" }, { children: description })), jsx("ul", __assign({ className: "flex items-center space-x-3 mt-9" }, { children: socialLinks && socialLinks.map(function (eachLink, idx) {
                                        return (jsx("li", { children: jsx("a", __assign({ href: "#", title: "", className: "flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600" }, { children: eachLink.type === "twitter" ?
                                                    jsx("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: jsx("path", { d: "M19.633 7.997c.013.175.013.349.013.523 0 5.325-4.053 11.461-11.46 11.461-2.282 0-4.402-.661-6.186-1.809.324.037.636.05.973.05a8.07 8.07 0 0 0 5.001-1.721 4.036 4.036 0 0 1-3.767-2.793c.249.037.499.062.761.062.361 0 .724-.05 1.061-.137a4.027 4.027 0 0 1-3.23-3.953v-.05c.537.299 1.16.486 1.82.511a4.022 4.022 0 0 1-1.796-3.354c0-.748.199-1.434.548-2.032a11.457 11.457 0 0 0 8.306 4.215c-.062-.3-.1-.611-.1-.923a4.026 4.026 0 0 1 4.028-4.028c1.16 0 2.207.486 2.943 1.272a7.957 7.957 0 0 0 2.556-.973 4.02 4.02 0 0 1-1.771 2.22 8.073 8.073 0 0 0 2.319-.624 8.645 8.645 0 0 1-2.019 2.083z" }) }))
                                                    : eachLink.type === "facebook" ?
                                                        jsx("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: jsx("path", { d: "M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z" }) }))
                                                        : eachLink.type === "instagram" ?
                                                            jsxs("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: [jsx("path", { d: "M11.999 7.377a4.623 4.623 0 1 0 0 9.248 4.623 4.623 0 0 0 0-9.248zm0 7.627a3.004 3.004 0 1 1 0-6.008 3.004 3.004 0 0 1 0 6.008z" }), jsx("circle", { cx: "16.806", cy: "7.207", r: "1.078" }), jsx("path", { d: "M20.533 6.111A4.605 4.605 0 0 0 17.9 3.479a6.606 6.606 0 0 0-2.186-.42c-.963-.042-1.268-.054-3.71-.054s-2.755 0-3.71.054a6.554 6.554 0 0 0-2.184.42 4.6 4.6 0 0 0-2.633 2.632 6.585 6.585 0 0 0-.419 2.186c-.043.962-.056 1.267-.056 3.71 0 2.442 0 2.753.056 3.71.015.748.156 1.486.419 2.187a4.61 4.61 0 0 0 2.634 2.632 6.584 6.584 0 0 0 2.185.45c.963.042 1.268.055 3.71.055s2.755 0 3.71-.055a6.615 6.615 0 0 0 2.186-.419 4.613 4.613 0 0 0 2.633-2.633c.263-.7.404-1.438.419-2.186.043-.962.056-1.267.056-3.71s0-2.753-.056-3.71a6.581 6.581 0 0 0-.421-2.217zm-1.218 9.532a5.043 5.043 0 0 1-.311 1.688 2.987 2.987 0 0 1-1.712 1.711 4.985 4.985 0 0 1-1.67.311c-.95.044-1.218.055-3.654.055-2.438 0-2.687 0-3.655-.055a4.96 4.96 0 0 1-1.669-.311 2.985 2.985 0 0 1-1.719-1.711 5.08 5.08 0 0 1-.311-1.669c-.043-.95-.053-1.218-.053-3.654 0-2.437 0-2.686.053-3.655a5.038 5.038 0 0 1 .311-1.687c.305-.789.93-1.41 1.719-1.712a5.01 5.01 0 0 1 1.669-.311c.951-.043 1.218-.055 3.655-.055s2.687 0 3.654.055a4.96 4.96 0 0 1 1.67.311 2.991 2.991 0 0 1 1.712 1.712 5.08 5.08 0 0 1 .311 1.669c.043.951.054 1.218.054 3.655 0 2.436 0 2.698-.043 3.654h-.011z" })] }))
                                                            :
                                                                eachLink.type === "github" ?
                                                                    jsx("svg", __assign({ className: "w-4 h-4", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" }, { children: jsx("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M12.026 2c-5.509 0-9.974 4.465-9.974 9.974 0 4.406 2.857 8.145 6.821 9.465.499.09.679-.217.679-.481 0-.237-.008-.865-.011-1.696-2.775.602-3.361-1.338-3.361-1.338-.452-1.152-1.107-1.459-1.107-1.459-.905-.619.069-.605.069-.605 1.002.07 1.527 1.028 1.527 1.028.89 1.524 2.336 1.084 2.902.829.091-.645.351-1.085.635-1.334-2.214-.251-4.542-1.107-4.542-4.93 0-1.087.389-1.979 1.024-2.675-.101-.253-.446-1.268.099-2.64 0 0 .837-.269 2.742 1.021a9.582 9.582 0 0 1 2.496-.336 9.554 9.554 0 0 1 2.496.336c1.906-1.291 2.742-1.021 2.742-1.021.545 1.372.203 2.387.099 2.64.64.696 1.024 1.587 1.024 2.675 0 3.833-2.33 4.675-4.552 4.922.355.308.675.916.675 1.846 0 1.334-.012 2.41-.012 2.737 0 .267.178.577.687.479C19.146 20.115 22 16.379 22 11.974 22 6.465 17.535 2 12.026 2z" }) })) : null })) }, idx));
                                    }) }))] })), jsxs("div", { children: [jsx("p", __assign({ className: "text-sm font-semibold tracking-widest text-gray-400 uppercase" }, { children: "Company" })), jsx("ul", __assign({ className: "mt-6 space-y-4" }, { children: company && company.map(function (each, idx) {
                                        return (jsx("li", { children: jsxs("a", __assign({ href: each.link, title: "", className: "flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600" }, { children: [" ", each.title, " "] })) }, idx));
                                    }) }))] }), jsxs("div", { children: [jsx("p", __assign({ className: "text-sm font-semibold tracking-widest text-gray-400 uppercase" }, { children: "Help" })), jsx("ul", __assign({ className: "mt-6 space-y-4" }, { children: help && help.map(function (each, idx) {
                                        return (jsx("li", { children: jsxs("a", __assign({ href: each.link, title: "", className: "flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600" }, { children: [" ", each.title, " "] })) }, idx));
                                    }) }))] }), jsxs("div", __assign({ className: "col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8" }, { children: [jsx("p", __assign({ className: "text-sm font-semibold tracking-widest text-gray-400 uppercase" }, { children: "Subscribe to newsletter" })), jsxs("form", __assign({ action: "#", method: "POST", className: "mt-6" }, { children: [jsxs("div", { children: [jsx("label", __assign({ htmlFor: "email", className: "sr-only" }, { children: "Email" })), jsx("input", { type: "email", name: "email", id: "email", placeholder: "Enter your email", className: "block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" })] }), jsx("button", __assign({ type: "submit", className: "inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700" }, { children: "Subscribe" }))] }))] }))] })), jsx("hr", { className: "mt-16 mb-10 border-gray-200" }), jsx("p", __assign({ className: "text-sm text-center text-gray-600" }, { children: "\u00A9 Copyright 2021, All Rights Reserved by Postcraft" }))] })) })));
};
...
var C001$2 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-gray-900 sm:py-16 lg:py-24" }, { children: jsxs("div", __assign({ className: "max-w-5xl px-4 mx-auto sm:px-6 lg:px-8" }, { children: [jsxs("div", __assign({ className: "max-w-2xl mx-auto text-center" }, { children: [jsx("h2", __assign({ className: "text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl" }, { children: title })), jsx("p", __assign({ className: "max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-300" }, { children: description }))] })), jsx("div", __assign({ className: "grid grid-cols-1 mt-12 md:mt-20 md:grid-cols-2 gap-y-16 gap-x-20" }, { children: queries && queries.map(function (each, idx) {
                        return (jsxs("div", __assign({ className: "flex items-start" }, { children: [jsx("div", __assign({ className: "flex items-center justify-center flex-shrink-0 w-8 h-8 bg-gray-700 rounded-full" }, { children: jsx("span", __assign({ className: "text-lg font-semibold text-white" }, { children: "?" })) })), jsxs("div", __assign({ className: "ml-4" }, { children: [jsx("p", __assign({ className: "text-xl font-semibold text-white" }, { children: each.title })), jsx("p", __assign({ className: "mt-4 text-base text-gray-400" }, { children: each.description }))] }))] }), idx));
                    }) })), jsx("div", __assign({ className: "flex items-center justify-center mt-12 md:mt-20" }, { children: jsx("div", __assign({ className: "px-8 py-4 text-center bg-gray-800 rounded-full" }, { children: jsxs("p", __assign({ className: "text-gray-50" }, { children: ["Didn\u2019t find the answer you are looking for? ", jsx("a", __assign({ href: contactLink, title: "", className: "text-yellow-300 transition-all duration-200 hover:text-yellow-400 focus:text-yellow-400 hover:underline" }, { children: "Contact our support" }))] })) })) }))] })) })));
};
...
var C001$1 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-gray-50 sm:py-16 lg:py-24" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" }, { children: [jsx("div", __assign({ className: "text-center" }, { children: jsx("h2", __assign({ className: "text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl" }, { children: title })) })), jsx("div", __assign({ className: "px-5 py-8 mt-12 bg-white lg:mt-20 lg:p-16" }, { children: jsx("div", __assign({ className: "grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2" }, { children: items && items.map(function (each, idx) {
                            return (jsx("div", __assign({ className: "flex items-start" }, { children: jsxs("div", __assign({ className: "ml-5" }, { children: [jsx("h3", __assign({ className: "text-lg font-semibold text-black" }, { children: each.title })), jsx("p", __assign({ className: "mt-4 text-base text-gray-600" }, { children: each.description }))] })) }), idx));
                        }) })) }))] })) })));
};
...
var C002$1 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-gray-50 sm:py-16 lg:py-24" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" }, { children: [jsxs("div", __assign({ className: "max-w-xl mx-auto text-center" }, { children: [jsx("div", __assign({ className: "inline-flex px-4 py-1.5 mx-auto rounded-full bg-gradient-to-r from-fuchsia-600 to-blue-600" }, { children: jsx("p", __assign({ className: "text-xs font-semibold tracking-widest text-white uppercase" }, { children: shortTitle })) })), jsx("h2", __assign({ className: "mt-6 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl" }, { children: title })), jsx("p", __assign({ className: "mt-4 text-base leading-relaxed text-gray-600" }, { children: description }))] })), jsx("div", __assign({ className: "grid grid-cols-1 gap-5 mt-12 sm:grid-cols-3 lg:mt-20 lg:gap-x-12" }, { children: items && items.slice(0, 3).map(function (each, idx) {
                        return (jsx("div", __assign({ className: "transition-all duration-200 bg-white hover:shadow-xl" }, { children: jsxs("div", __assign({ className: "py-10 px-9" }, { children: [jsx("h3", __assign({ className: "mt-8 text-lg font-semibold text-black" }, { children: each.title })), jsx("p", __assign({ className: "mt-4 text-base text-gray-600" }, { children: each.description }))] })) }), idx));
                    }) }))] })) })));
};
...
var C001 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-gray-100 sm:py-16 lg:py-24" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl" }, { children: [jsxs("div", __assign({ className: "max-w-2xl mx-auto text-left sm:text-center" }, { children: [jsx("h2", __assign({ className: "text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl" }, { children: title })), jsx("p", __assign({ className: "max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600" }, { children: description }))] })), jsx("div", __assign({ className: "mt-8 space-y-8 sm:space-x-12 sm:mt-12 sm:flex sm:items-start sm:justify-center sm:space-y-0 md:space-x-20 lg:mt-20" }, { children: items && items.map(function (each, idx) {
                        return (jsxs("div", __assign({ className: "flex items-start" }, { children: [jsx("svg", __assign({ className: "flex-shrink-0 text-orange-400 w-7 h-7", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" }, { children: jsx("path", { "fill-rule": "evenodd", d: "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z", "clip-rule": "evenodd" }) })), jsxs("div", __assign({ className: "ml-4" }, { children: [jsx("h3", __assign({ className: "text-xl font-semibold text-black" }, { children: each.title })), jsx("p", __assign({ className: "mt-1.5 text-base text-gray-600" }, { children: each.subtitle }))] }))] }), idx));
                    }) })), jsx("form", __assign({ action: "#", method: "POST", className: "max-w-xl mx-auto mt-12" }, { children: jsx("div", __assign({ className: "sm:p-2 sm:bg-white sm:border-2 sm:border-transparent sm:rounded-full sm:focus-within:border-blue-600 sm:focus-within:ring-1 sm:focus-within:ring-blue-600" }, { children: jsxs("div", __assign({ className: "flex flex-col items-start sm:flex-row sm:justify-center" }, { children: [jsx("div", __assign({ className: "flex-1 w-full min-w-0" }, { children: jsxs("div", __assign({ className: "relative text-gray-400 focus-within:text-gray-600" }, { children: [jsx("label", { htmlFor: "email", className: "sr-only" }), jsx("div", __assign({ className: "absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none" }, { children: jsx("svg", __assign({ className: "w-5 h-5", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.5", d: "M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" }) })) })), jsx("input", { type: "email", name: "email", id: "email", placeholder: "Enter email address", className: "block w-full py-4 pl-10 pr-4 text-base text-black placeholder-gray-500 transition-all duration-200 border-transparent rounded-full focus:border-transparent focus:ring-0 caret-blue-600", required: true })] })) })), jsxs("button", __assign({ type: "submit", className: "inline-flex items-center justify-center w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-full sm:ml-4 sm:mt-0 sm:w-auto hover:bg-blue-700 focus:bg-blue-700" }, { children: ["Get instant access", jsx("svg", __assign({ className: "w-5 h-5 ml-3 -mr-1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" }, { children: jsx("path", { "fill-rule": "evenodd", d: "M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z", "clip-rule": "evenodd" }) }))] }))] })) })) })), jsxs("div", __assign({ className: "flex items-center justify-start mt-8 sm:justify-center sm:px-0" }, { children: [jsx("svg", __assign({ className: "flex-shrink-0 w-5 h-5 text-gray-600", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.5", d: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" }) })), jsx("span", __assign({ className: "ml-2 text-sm text-gray-600" }, { children: " Your data is complely secured with us. We don\u2019t share with anyone. " }))] }))] })) })));
};
...
var C002 = function (_a) {
    ...
    return (jsx("section", __assign({ className: "py-10 bg-gray-100 sm:py-16 lg:py-24" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl" }, { children: [jsxs("div", __assign({ className: "max-w-2xl mx-auto text-center" }, { children: [jsx("h2", __assign({ className: "text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl" }, { children: title })), jsx("p", __assign({ className: "max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600" }, { children: description }))] })), jsx("form", __assign({ action: "#", method: "POST", className: "max-w-xl mx-auto mt-12" }, { children: jsxs("div", __assign({ className: "flex flex-col items-center sm:flex-row sm:justify-center" }, { children: [jsxs("div", __assign({ className: "flex-1 w-full min-w-0 px-4 sm:px-0" }, { children: [jsx("label", { htmlFor: "email", className: "sr-only" }), jsx("input", { type: "email", name: "email", id: "email", placeholder: "Enter email to get started", className: "block w-full px-4 py-4 text-base text-black placeholder-gray-500 transition-all duration-200 border-transparent rounded-md caret-indigo-600 focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600", required: true })] })), jsxs("button", __assign({ type: "submit", className: "inline-flex items-center justify-center w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-indigo-600 border border-transparent rounded-md sm:ml-4 sm:mt-0 sm:w-auto hover:bg-indigo-700 focus:bg-indigo-700" }, { children: ["Get instant access", jsx("svg", __assign({ className: "w-5 h-5 ml-3 -mr-1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" }, { children: jsx("path", { "fill-rule": "evenodd", d: "M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z", "clip-rule": "evenodd" }) }))] }))] })) })), jsxs("div", __assign({ className: "flex items-center justify-center px-8 mt-8 sm:px-0" }, { children: [jsx("svg", __assign({ className: "flex-shrink-0 w-5 h-5 text-gray-600", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.5", d: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" }) })), jsx("span", __assign({ className: "ml-2 text-sm text-gray-600" }, { children: " Your data is complely secured with us. We don\u2019t share with anyone. " }))] }))] })) })));
};
