...
function C002$4(_a) {
    var _b = _a.features, features = _b === void 0 ? data$4.features : _b, _c = _a.logoSrc, logoSrc = _c === void 0 ? data$4.logoSrc : _c;
    var _d = React.useState(false), isOpened = _d[0], setOpen = _d[1];
    return (jsx("header", __assign({ className: "pb-6 bg-white lg:pb-0" }, { children: jsxs("div", __assign({ className: "px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" }, { children: [jsxs("nav", __assign({ className: "flex items-center justify-between h-16 lg:h-20" }, { children: [jsx("div", __assign({ className: "flex-shrink-0" }, { children: jsx("a", __assign({ href: "#", title: "", className: "flex" }, { children: jsx("img", { className: "w-auto h-8 lg:h-10", src: logoSrc, alt: "" }) })) })), jsx("button", __assign({ onClick: function () { return setOpen(!isOpened); }, type: "button", className: "inline-flex p-2 text-black transition-all duration-200 rounded-md lg:hidden focus:bg-gray-100 hover:bg-gray-100" }, { children: !isOpened ? jsx("svg", __assign({ className: "block w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M4 8h16M4 16h16" }) }))
                                : jsx("svg", __assign({ className: "w-6 h-6", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M6 18L18 6M6 6l12 12" }) })) })), jsx("div", __assign({ className: "hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10" }, { children: features.map(function (eachFeature, idx) {
                                return (jsxs("a", __assign({ href: eachFeature.href, title: "", className: "text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600" }, { children: [" ", eachFeature.title, " "] }), idx));
                            }) })), jsx("a", __assign({ href: "#", title: "", className: "items-center justify-center hidden px-4 py-3 ml-10 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md lg:inline-flex hover:bg-blue-700 focus:bg-blue-700", role: "button" }, { children: " Get started now " }))] })), isOpened && jsxs("nav", __assign({ className: "pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden" }, { children: [jsx("div", __assign({ className: "flow-root" }, { children: jsx("div", __assign({ className: "flex flex-col px-6 -my-2 space-y-1" }, { children: features.map(function (eachFeature, idx) {
                                    return (jsxs("a", __assign({ href: eachFeature.href, title: "", className: "inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600" }, { children: [" ", eachFeature.title, " "] })));
