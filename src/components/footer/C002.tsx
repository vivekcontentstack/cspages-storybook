                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            {company && company.map((each, idx) => {
                                return (
                                    <li key={idx}>
                                        <a href={each} title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> {each} </a>
                                    </li>
                                )
                            })}
                        </ul>
