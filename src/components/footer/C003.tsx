        ...
        <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <div>
                        ...
                        <ul className="mt-8 space-y-4">
                            {company && company.map((each, idx) => {
                                return (
                                    <li key={idx} >
                                        <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> {each} </a>
                                    </li>
                ...
                <div className="flex flex-wrap items-center justify-between">
                    ...
                    {socialLinks && socialLinks.map((eachLink, idx) => {
                                return (
                                    <li key={idx} >
...
Footer_C003.propRequire = RequireProps
Footer_C003.cname = "Footer_C003"
export default Footer_C003