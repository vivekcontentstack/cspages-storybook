          ...
          <div x-data="
            ...
            <div className="relative flex justify-center">
              <div className="relative w-full pb-16">
                <div className="snap mx-auto flex h-auto w-full max-w-[300px] flex-nowrap overflow-hidden transition-all xs:max-w-[400px] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px]" x-ref="carousel">
                  ...
                  <div className="mx-auto h-full min-w-[300px] px-4 xs:min-w-[368px] sm:min-w-[510px] md:min-w-[350px] lg:min-w-[465px] xl:min-w-[370px] 2xl:min-w-[430px]">
                    <div className="overflow-hidden rounded-lg border border-[#e7e7e7] bg-white">
                      <div>
                        <img src="https://demo.tailgrids.com/templates/shopper/build/src/assets/ecom-images/products/product-carousel-05/image-02.jpg" alt="product" className="w-full" />
                      </div>
                      <div className="p-6">
                        <a href="product-details.html" className="mb-4 block text-lg font-semibold text-black hover:text-primary xs:text-xl lg:text-lg xl:text-xl">
                          iPhone 13 Pro Max
                  ...
                  <div className="mx-auto h-full min-w-[300px] px-4 xs:min-w-[368px] sm:min-w-[510px] md:min-w-[350px] lg:min-w-[465px] xl:min-w-[370px] 2xl:min-w-[430px]">
                    <div className="overflow-hidden rounded-lg border border-[#e7e7e7] bg-white">
                      <div>
                        <img src="https://demo.tailgrids.com/templates/shopper/build/src/assets/ecom-images/products/product-carousel-05/image-03.jpg" alt="product" className="w-full" />
                      </div>
                      <div className="p-6">
                        <a href="product-details.html" className="mb-4 block text-lg font-semibold text-black hover:text-primary xs:text-xl lg:text-lg xl:text-xl">
